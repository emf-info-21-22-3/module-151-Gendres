    ...
    $("#view").load("views/" + view + ".html", () => {
      ...
      if (view === "login") {
        ...
        $("#create-btn").click((event) => {
          ...
          $("#login-form").append(
            "<input type='password' placeholder='Confirmer mot de passe' class='input-field' id='password-conf'>"
          );
          $("#login-form").append(
            '<button type="button" class="login-btn" id="create-btn">Créer un compte</button>'
          );
          $("#login-form").append(
            '<button type="button" class="login-btn" id="back-btn">Retour</button>'
          );
